...
class DataProvider:
    def __init__(self, file_path, downsample_factor):
        ...
        grinding_l1_data = current_data['Grinding spindle current L1_rate100000_clipping0_batch0']
        ...
        self.downsampled_grinding_l1_data = grinding_l1_data[::current_downsample_factor]
        self.downsampled_grinding_l2_data = grinding_l2_data[::current_downsample_factor]
        self.downsampled_grinding_l3_data = grinding_l3_data[::current_downsample_factor]
    ...
    def next(self):
        ...
        grinding_sample_l1 = self.downsampled_grinding_l1_data.iloc[self.index]
        grinding_sample_l2 = self.downsampled_grinding_l2_data.iloc[self.index]
        grinding_sample_l3 = self.downsampled_grinding_l3_data.iloc[self.index]
        self.index += 1
